/**
 * @file lv_conf.h
 * Configuration file for v8.3.7 - FIXED FOR ESP32-S3 PSRAM
 */
...
/*=========================
   MEMORY SETTINGS - FIXED FOR ESP32-S3
 *=========================*/
...
#else       /*LV_MEM_CUSTOM - USE ESP32 HEAP CAPS FOR PSRAM*/
...
/*GIF decoder library - ENABLED FOR KNOMI*/
#define LV_USE_GIF 1
